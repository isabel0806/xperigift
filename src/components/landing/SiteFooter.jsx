      ...
      <div className="mx-auto max-w-[1100px] px-6 sm:px-10 py-14">
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-3">
            <p className="text-[12px] uppercase tracking-[0.14em] text-ink-muted">Company</p>
          ...
          <div className="md:col-span-4">
            <p className="text-[12px] uppercase tracking-[0.14em] text-ink-muted">Get started</p>
        ...
        <div className="mt-14 flex flex-col-reverse sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-hairline pt-6">
          ...
          <div className="flex items-center gap-5">
            <Link to="/portal" className="text-[12px] text-ink-muted hover:text-ink">
              Client login
            </Link>
