...
const industries = [
  {
    id: 'spas', icon: Sparkles, name: 'Spas',
  ...
  {
    id: 'salons', icon: Scissors, name: 'Salons',
  ...
  {
    id: 'golf-clubs', icon: Flag, name: 'Golf clubs',
  ...
  {
    id: 'specialty-retail', icon: ShoppingBag, name: 'Specialty retail',
  ...
  {
    id: 'gun-shops', icon: Target, name: 'Gun shops',
      ...
      <section className="bg-ink text-paper">
        <div className="mx-auto max-w-[1100px] px-6 sm:px-10 py-16 sm:py-24 text-center">
          ...
          <div className="mt-9 flex justify-center">
            <CTALink to="/book-audit" size="lg" className="bg-xg-terracotta hover:bg-xg-terracotta-dark text-white">
